...
const { registerUser, loginUser, getUserProfile, updateUserProfile, getUsers, forgotPassword, toggleUserBlockStatus, updateUserByAdmin } = require('../controllers/authController.js');
